  ...
  return (
    <footer className="relative w-full bg-[#151515] py-6">
      <div className="mx-auto w-full px-8">
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="white"
                  className="mb-3 font-extrabold text-xl text-red-900 "
                >
                  {title}
                </Typography>
                {items.map((link) => (
        ...
        <div className="mt-12  w-full  items-center justify-center border-t border-blue-gray-50 py-4">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-white md:mb-0"
          >
            &copy; {currentYear}{" "}
            <a href="https://car-doctor-pro.com/">RestroHub</a>. All Rights
            Reserved.
          </Typography>
        </div>
      </div>
